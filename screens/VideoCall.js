...
export default function VideoCall({ isExtended, setIsExtended }) {
  ...
  return (
      ...
      >
        ...
        <View style={[styles.section, styles.sectionLarge]}>
          <Text color="white" hCenter size={15} style={styles.description}> A powerful starter project that bootstraps development of your mobile application and saves you $20 000*</Text>
